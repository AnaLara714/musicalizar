...
function Footer() {
    return (
        <footer id="localização" className="bg-black-900 text-white max-h-24">
            <div className="container mx-auto bg-black mb-8 flex flex-col lg:flex-row justify-around max-w-full p-4">
                ...
                <div className="flex flex-col gap-2">
                    <div className="flex justify-center space-x-8 flex-row" >
                        <a href="#conheça-nos" className=" text-gray-400 hover:text-white">Conheça nós</a>
                        ...
                        <a href="#localização" className="text-gray-400 hover:text-white">Localização</a>
                    </div>
                ...
                <Link to="/gerenciador">Gerenciar</Link>
                </div>
            </div>
        </footer>
    )
