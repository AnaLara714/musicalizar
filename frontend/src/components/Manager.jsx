...
export default function Manager() {
  ...
  return (
    <div className="min-h-screen bg-[#7FE7FF] p-4 sm:p-6 md:p-8 lg:px-12 xl:px-40  ">
      {}
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 md:mb-8 gap-4 max-w-[1400px]">
      ...
      {}
      <h2 className="text-xl sm:text-2xl md:text-3xl font-nerko">Cursos</h2>
